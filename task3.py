...
"""
# TASK 3: This program should perform a simulation of a variable number of particle moving in two-dimensions inside a box with hard reflecting walls.
#         This task requires you to complete the setup of the starting configuration and to create a new move() function.
# 
# EXPECTED OUTCOME: An animation of a variable number of dots moving inside a rectangular box and bounching back and forth.
#
...
# TASK3: to test your code you can choose a small number of particles (e.g. n=2) but your code should work for any integer number n > 0
#
nparticles= # TASK3: set this to an arbitrary number
...
# TASK3: to test your code you can fix the initial positions and velocities by hand, but for a generic number of particles you want to 
# initialize positions and velocities using random numbers (e.g. using the numpy.random.uniform() function)
#
xpos=[] # TASK3: this should be a list (or a numpy array) with nparticles elements, corresponding to the x-coordinates of the particles. 
# NOTE: initial positions should be inside the [0,xbox] interval
ypos=[] # TASK3: this should be a list (or a numpy array) with nparticles elements, corresponding to the y-coordinates of the particles. 
...
xvel=[] # TASK3: this should be a list (or a numpy array) with nparticles elements, corresponding to the x-component of the particles's velocities. 
# NOTE: initial velocities can be considered to be inside the [-1.,1.] interval.
yvel=[] # TASK3: this should be a list (or a numpy array) with nparticles elements, corresponding to the x-component of the particles's velocities. 
...
def move(dt,xpos,ypos,xvel,yvel,xbox,ybox):
    ...
    #          change the sign of the corresponding component of the velocity (xvel/yvel).
    #       
